...
export function FloorPlanCropper({ src, onAnalyze, labels }: { src: string; onAnalyze: (dataUrl: string, imageData: ImageData) => void; labels?: { instruction?: string; action?: string; pan?: string; crop?: string } }) {
