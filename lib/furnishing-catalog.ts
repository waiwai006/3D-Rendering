...
export const FURNISHING_CATALOG: FurnishingCatalogItem[] = [
  ...
  {
    id: "ikea-friheten-sofa-bed", name: "FRIHETEN sofa-bed", brand: "IKEA", category: "furniture", shape: "sofa",
  ...
  {
    id: "ikea-malm-single", name: "MALM single bed", brand: "IKEA", category: "furniture", shape: "bed",
  ...
  {
    id: "ikea-lack-coffee-table", name: "LACK coffee table", brand: "IKEA", category: "furniture", shape: "table",
  ...
  {
    id: "ikea-poang-armchair", name: "POÄNG armchair", brand: "IKEA", category: "furniture", shape: "chair",
  ...
  {
    id: "ikea-pax-wardrobe", name: "PAX wardrobe", brand: "IKEA", category: "furniture", shape: "wardrobe",
  ...
  {
    id: "ikea-billy-bookcase", name: "BILLY bookcase", brand: "IKEA", category: "furniture", shape: "bookcase",
  ...
  {
    id: "ikea-besta-tv-bench", name: "BESTÅ TV bench", brand: "IKEA", category: "furniture", shape: "cabinet",
  ...
  {
    id: "ikea-kallax-shelf", name: "KALLAX shelf unit", brand: "IKEA", category: "furniture", shape: "bookcase",
  ...
  {
    id: "ikea-ekedalen-extendable", name: "EKEDALEN extendable dining table", brand: "IKEA", category: "furniture", shape: "table",
  ...
  {
    id: "ikea-brimnes-storage-bed", name: "BRIMNES storage bed", brand: "IKEA", category: "furniture", shape: "bed",
  ...
  {
    id: "fortress-43-tv", name: "43-inch television", brand: "Fortress baseline", category: "electronics", shape: "tv",
  ...
  {
    id: "fortress-front-load-washer", name: "Front-load washing machine", brand: "Fortress baseline", category: "electronics", shape: "washer",
  ...
  {
    id: "fortress-microwave", name: "Countertop microwave oven", brand: "Fortress baseline", category: "electronics", shape: "microwave",
  ...
  {
    id: "fortress-window-aircon", name: "Window air conditioner", brand: "Fortress baseline", category: "electronics", shape: "aircon",
  ...
  {
    id: "hktvmall-dehumidifier", name: "Dehumidifier", brand: "HKTVmall baseline", category: "electronics", shape: "fridge",
